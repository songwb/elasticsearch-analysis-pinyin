...
public class PinyinTokenizerForMultipleBak /*extends Tokenizer*/ {
...
//    LinkedHashSet<StringBuilder> firstLettersSet;
...
//    String source;
//
//    public PinyinTokenizerForMultipleBak(PinyinConfig config) {
...
//    }
//
//    public PinyinTokenizerForMultipleBak(int bufferSize) {
//        super();
...
//                                }else{
//                                    firstLetters = new StringBuilder(firstLetters.substring(0,firstLetters.length()-1)+pinyin.charAt(0));
//                                }
//                                String content = firstLetters.toString();
//                                if(content.length() == sourceLength){
//                                    firstLettersSet.add(new StringBuilder(content));
//                                }
//
...
//                processedFirstLetter = true;
//                for(StringBuilder firstLetterTmp : firstLettersSet){
//                    String fl;
