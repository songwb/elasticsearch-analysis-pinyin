...
public class PinyinTokenizerForMultipleBak2 /*extends Tokenizer*/ {
...
//    String source;
//
//    public PinyinTokenizerForMultipleBak2(PinyinConfig config) {
...
//        firstLettersSet = new SoftReference<>(new LinkedHashSet<>());
//        fullPinyinLetters = new StringBuilder();
//    }
//
//    public PinyinTokenizerForMultipleBak2(int bufferSize) {
//        super();
...
//                                    doPosition=true;
//                                }
//                                if(firstLettersSet != null && firstLettersSet.get().size()>0){
//                                    LinkedHashSet<String> firstLettersSetTmp = new LinkedHashSet<>();
//                                    Iterator<String> firstLetterIterator = firstLettersSet.get().iterator();
...
//                                        firstLettersSetTmp.add(StringUtils.compress(firstLetterBuilder.toString()));
//                                    }
//                                    firstLettersSet.get().clear();
//                                    firstLettersSet.get().addAll(firstLettersSetTmp);
//                                }else {
//                                    firstLetters.append(pinyin.charAt(0));
//                                    firstLettersSet.get().add(StringUtils.compress(firstLetters.toString()));
//                                }
//
...
////            }
//
//            if (config.keepFirstLetter && firstLettersSet.get().size() > 0 && !processedFirstLetter) {
//                processedFirstLetter = true;
//                for(String flTmp : firstLettersSet.get()){
