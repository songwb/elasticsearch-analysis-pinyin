...
public class PinyinAnalysisTests {
     ...
     */
    @Test
    public void TestTokenizerForMultiple() throws IOException {
        System.out.println("项目数据来源于“我的团队”，如需调整项目成员，请联系项目管理者到“我的团队”中进行操作。项目数据来源于“我的团队”，如需调整项目成员，请联系项目管理者到“我的团队”中进行操作。项目数据来源于“我的团队”，如需调整项目成员，请联系项目管理者到“我的团队”中进行操作。项目数据来源于“我的团队”，如需调整项目成员，请联系项目管理者到“我的团队”中进行操作。".length());
        String[] s =
                {
//                        "管家智慧服务地区项目职能负责人",
//                        "片区巡逻员工",
...
//                        "售场管理员工",
//                        "资金管理集团职能中心负责人管家智慧服",
                        "项目数据来源于“我的团队”，如需调整项目成员，请联系项目管理者到“我的团队”中进行操作。",
                        "单天放重"
                };
        ...
        for (String value : s) {
            ...
            PinyinTokenizerForMultiple tokenizer = new PinyinTokenizerForMultiple(config);
    ...
    @Test
    public void TestTokenizer1() throws IOException {
        String[] s =
                {
                        "项目数据来源于我的团队如需调整项目成员请联系项目管理者到我的团队中进行操作"
//                    "人民银行"
                };
...
//        Assert.assertEquals(2, re.get(1).endOffset);
    ...
    @Test
    public void TestPinyinForMultiple() {
        List<String> result = Pinyin.pinyinForMultiple("单");
        for (int i = 0; i < result.size(); i++) {
            String s = result.get(i);
            System.out.println(s);
        }
